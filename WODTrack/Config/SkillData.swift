...
enum SkillLibrary {
    ...
    private static let gymnasticSkills: [SkillDefinition] = [
        ...
        s("ring_row", "吊环划船", "gym_m03", .l1, "上肢拉(水平)", "次数",
          intro: "我给了你一份最新整理的动作库数据，里面有两个 sheet，我们将只用到“动作库”这个 sheet。", steps: "握环身体后倾成直线，把胸尽量拉向吊环，控制放回，环越低越难。", keyPoints: "吊环训练入门动作，也是引体向上的进阶过渡；吊环越低越难。",
          scaling: "升高吊环减难 / 屈膝减难", prereqs: [], rationale: "基础动作", englishName: "Ring Row"),
        s("air_squat", "徒手深蹲", "gym_m04", .l1, "深蹲", "次数",
          intro: "", steps: "双脚与肩同宽，屈髋屈膝下蹲至髋低于膝，膝随脚尖外展，蹬地站直。", keyPoints: "学习正确深蹲的最佳方式是先无负重打好动作基础。",
          scaling: "扶撑深蹲 / 坐箱深蹲", prereqs: [], rationale: "基础动作", englishName: "Air Squat"),
        s("shuttle_sprint", "折返跑", "gym_m02", .l1, "位移有氧", "距离/次数",
          intro: "请用这份数据来更新整个动作库的模型。这里面有很多字段都是可以使用的。", steps: "在标志物间全力冲刺折返，转身减速时控制身体，按要求完成距离或次数。", keyPoints: "在安全地面进行、做好热身、穿合适鞋；折返距离宜短（≤15-20 米）。",
